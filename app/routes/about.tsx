        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              Test4Funs는 학습을 재미있게 만드는 것을 목표로 합니다. 다양한
              주제의 퀴즈를 통해 사용자들이 즐겁게 지식을 습득하고, 기억에 오래
              남는 학습 경험을 제공합니다.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                세계 각국의 국기를 보고 나라를 맞춰보세요. 지리와 국제 관계에
                대한 지식을 늘릴 수 있습니다.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                한국 프로축구 K리그의 선수들을 맞춰보세요. 국내 축구에 대한
                관심과 지식을 키울 수 있습니다.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                한국 프로농구 KBL의 선수들을 맞춰보세요. 국내 농구 리그에 대한
                이해를 높일 수 있습니다.
              </p>
            </div>
          </div>
